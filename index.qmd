...
-   [Lisa Gollot](https://orcid.org/0009-0004-5074-4275)$^{ab}$ : Conceptualization, Data curation, Formal Analysis, Investigation, Methodology, Software, Validation, Visualization, Writing – Original Draft Preparation.
-   [Cleo Bodin](https://orcid.org/0000-0003-3470-157X)$^{b}$ : Formal Analysis, Methodology, Resources, Software.
-   Laura Frattaroli (INRAE research technician) : Data curation, Investigation, Methodology, Writing – Review & Editing.
-   [Rémy Beaudouin](https://orcid.org/0000-0002-2855-1571)$^{bc}$ : Formal Analysis, Funding Acquisition, Methodology, Resources, Supervision, Writing – Review & Editing.
-   [Raphaël Royauté](https://rroyaute.github.io)$^{a}$ : Conceptualization, Funding Acquisition, Methodology, Project Administration, Resources, Supervision, Writing – Review & Editing.
-   [Juliette Faburé](https://orcid.org/0000-0002-8055-3224)$^{a}$ : Funding Acquisition, Methodology, Resources, Supervision, Writing – Review & Editing.

$^a$ : Université Paris-Saclay, INRAE, AgroParisTech, UMR EcoSys, 91120 Palaiseau, France

$^b$ : Experimental Toxicology and Modeling Unit, INERIS, 65550 Verneuil en Halatte, France

$^c$ : Institut national de l'environnement industriel et des risques, Université de Reims Champagne-Ardenne, Université Le Havre Normandie, Normandie Univ, UMR-I 02 SEBIO, 60550 Verneuil-en-Halatte, France
