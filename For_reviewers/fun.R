...
f_read_data_expA_hatchlings <- function(){
  ...
  df_hatchlings_tot <- read_excel(here::here("Data_EC50.xlsx"), sheet="Hatchlings") |>
...
f_read_data_expB <- function() {
  ...
  df_mix_ind <- read_excel(here::here("Data_Mix.xlsx"), sheet = "ReproSpring2025weight") |>
    mutate(
  ...
  df_mix_coc <- read_excel(here::here("Data_Mix.xlsx"), sheet = "ReproSpring2025coc") |>
    mutate(
      Condition = paste0(Ratio, Line),
  ...
  df_mix_cocsize <- read_excel(here::here("Data_Mix.xlsx"), sheet="ReproSpring2025cocsize") |> 
    mutate(
      Condition = paste0(Ratio, Line),
  ...
  df_mix_hatch_wide_D <- read_excel(here::here("Data_Mix.xlsx"), sheet="ReproSpring2025hatchlingsLotD") |> 
    dplyr::select(-Reste) |> 
  ...
  df_mix_hatch_wide_E <- read_excel(here::here("Data_Mix.xlsx"), sheet="ReproSpring2025hatchlingsLotE") |> 
    dplyr::select(-Reste)|> 
