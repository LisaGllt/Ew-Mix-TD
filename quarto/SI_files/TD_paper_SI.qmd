---
title: "Toxic cocktails in soils: Evidence for synergistic effects of the imidacloprid-epoxiconazole mixture on earthworm life-history traits"
...
![Initial body weight of earthworms used in the experiment MIX. Earthworm assigned to lot D are represented in blue while the ones assigned to lot E are represented in dark grey.](../../fig/Mixture/Spring/ExpB_initial_weights.png){#fig-initMIX fig-scap="Initial body weight of earthworms used in the experiment MIX."}
...
lack-of-fit test with likelihood-ratio test : p value = 1.
...
| Model type | a | b | Log-Likelihood | Lack-of-fit p-value |
|----|----|----|----|----|
| CA | \- | \- | -395.2 | 6.75e-10 |
| CA-SA | -0.005 \[-1.06 ; 0.84\] | \- | -395.2 | 3.57e-10 |
| CA-DL | 1.6 \[-0.7 ; 5.5\] | 0.63 \[-174.4 ; 0.65\] | -392.3 | 1.63e-09 |
| CA-DR | -0.40 \[-3.4 ; 2.3\] | 0.9 \[-5.1 ; 6.7\] | -395.1 | 2.02e-10 |
| IA | \- | \- | -397.5 | 1.23e-10 |
| IA-SA | -1.5 \[-3.0 ; -0.2\] | \- | -391.3 | 5.92e-09 |
| IA-DL | -1.9 \[-6.8 ; -0.004\] | 0.6 \[-298.5 ; 2.3\] | -391.1 | 3.72e-09 |
| IA-DR | -1.6 \[-5.6 ; 2.1\] | 0.3 \[-8.2 ; 8.1\] | -391.3 | 3.21e-09 |

: Estimated interaction parameters by the different Jonker interaction models and their lack-of-fit test.

lack-of-fit tests were performed on each model with log-likelihood-ratio tests (Log-likelihood anova model = -342.1) :
...
![Estimated dose-response surfaces isoboles by the CA (grey) and the IA (blue) model. Blue numbers aside each isobole correspond to the level of the isobole in produced cocoons.](../../fig/Mixture/Spring/ExpB_2D_data_CAIA.png){fig-scap="Estimated dose-response surfaces isoboles by the CA (grey) and the IA (blue) model."}

![Estimated dose-response surfaces isoboles by the IA-SA (blue) model. The isoboles from the IA model are represented in dotted lines.](../../fig/Mixture/Spring/ExpB_2D_data_IASA.png){fig-scap="Estimated dose-response surfaces isoboles by the IA-SA (blue) model."}

::: {#fig-predobs .unlisted layout-ncol="2"}
![Results of the CA model fit on experimental data.](fig/Article_2_SI/Figures_compressees/ExpB_Jonker_predobs_CA.png){.unlisted fig-scap="Results of the CA model fit on experimental data. Thin black and grey lines represent the 2-folds and 5-fold changes, respectively."}

![Results of the IA model fit on experimental data.](fig/Article_2_SI/Figures_compressees/ExpB_Jonker_predobs_IA.png){.unlisted fig-scap="Results of the IA model fit on experimental data. Thin black and grey lines represent the 2-folds and 5-fold changes, respectively."}

![Results of the CA-SA model fit on experimental data.](fig/Article_2_SI/Figures_compressees/ExpB_Jonker_predobs_CASA.png){.unlisted fig-scap="Results of the CA-SA model fit on experimental data."}

![Results of the IA-SA model fit on experimental data.](fig/Article_2_SI/Figures_compressees/ExpB_Jonker_predobs_IASA.png){.unlisted fig-scap="Results of the IA-SA model fit on experimental data."}

Predicted vs. observed data. Thin black and grey lines represent the 2-folds and 5-fold changes, respectively. The thicker black line represents the identity line.
:::
