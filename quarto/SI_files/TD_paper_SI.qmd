...
![Experimental design of experiment B.](../../fig/Mixture/Design/Mixture_design_exp.png)

![Expected effect range for each effect isobole (red points).](../../fig/Mixture/Design/Mixture_design_effect_range.png)

![Initial body weight of earthworms used in the experiment B. Earthworm assigned to lot D are represented in blue while the ones assigned to lot E are represented in dark grey.](../../fig/Mixture/Spring/ExpB_initial_weights.png)
...
## Dose-response curves for the single substance tested during experiment B
