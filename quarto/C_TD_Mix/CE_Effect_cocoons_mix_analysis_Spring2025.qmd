...
LL1 <- LogLikelihood_anova    # log-vraisemblance du modèle CA
LL0 <- LogLikelihood_CA    # log-vraisemblance du modèle SA (CA reference)
...
LL1 <- LogLikelihood_anova    # log-vraisemblance du modèle CA
LL0 <- LogLikelihood_IA    # log-vraisemblance du modèle SA (CA reference)
...
LL1 <- LogLikelihood_anova    # log-vraisemblance du modèle CA
LL0 <- LogLikelihood_IASA    # log-vraisemblance du modèle SA (CA reference)
...
cat("Comparison Anova/IASA - D =", D, "p =", p_val, "\n")
